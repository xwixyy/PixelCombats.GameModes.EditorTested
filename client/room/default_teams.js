...
export const RED_TEAM_NAME = "TPEHUPOBKA1";
export const BLUE_TEAM_NAME = "TPEHUPOBKA";
export const RED_TEAM_DISPLAY_NAME = "TPEHUPOVKA1";
export const BLUE_TEAM_DISPLAY_NAME = "TPEHUPOBKA";
