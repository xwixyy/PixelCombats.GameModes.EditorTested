...
export const RED_TEAM_NAME = "ТРЕНИРОВКА1";
export const BLUE_TEAM_NAME = "ТРЕНИРОВКА";
export const RED_TEAM_DISPLAY_NAME = "Teams/ТРЕНИРОВКА1";
export const BLUE_TEAM_DISPLAY_NAME = "Teams/ТРЕНИРОВКА";
